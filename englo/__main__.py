...
Run as:
  python -m englo               # resume from saved progress
  python -m englo --reset       # wipe progress, start from scratch
  python -m englo --dry <wav>   # single turn with a pre-recorded WAV (no mic)
"""
